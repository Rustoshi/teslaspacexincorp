            ...
            <div className="mt-6 grid grid-cols-2 sm:flex sm:flex-wrap gap-3 max-w-full overflow-hidden">
                {quickLinks.map((link, i) => (
                    ...
                    >
                        <Link
                            href={link.href}
                            className={`flex items-center justify-center px-5 py-2.5 border transition-all rounded-full text-[10px] sm:text-[11px] font-bold tracking-widest uppercase group truncate w-full ${
                                (link as any).accent
                        ...
                        >
                            <span className={`transition-colors mr-1 shrink-0 ${
                                (link as any).accent
