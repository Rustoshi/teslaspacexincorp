...
export default function InvestError({
    ...
    useEffect(() => {
        console.error("Invest error boundary caught:", error);
    }, [error]);
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center px-6">
            <div className="text-center max-w-md">
                ...
                <h2
                    className="text-lg font-bold tracking-[0.15em] uppercase text-white mb-3"
                    style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                >
                    Unable to Load Page
                </h2>
                <p className="text-sm text-white/40 leading-relaxed mb-8">
                    We ran into an issue loading this page. Please try again or explore other sections.
                </p>
